...
function PaymentSuccess() {
  ...
  return (
    <div className="lg:mx-56 my-8 lg:my-16">
        <h1 className="text-[28px] lg:text-[36px] text-center font-semibold mb-8 text-[#00CE3A] whitespace-pre-line">결제가 정상적으로 완료 {!isLargeScreen && <br />}
        ...
        <div className="w-full my-8 custom-shadow-right-bottom lg:rounded-xl overflow-hidden">
            ...
            <div className="w-full flex flex-col-reverse lg:flex-row lg:p-12">
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center">
                    <img src="/images/payment_success.png" alt="" className='w-full lg:w-auto' />
                </div>
            </div>
        </div>
    </div>
