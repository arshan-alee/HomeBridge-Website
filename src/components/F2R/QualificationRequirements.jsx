...
const QualificationRequirements = () => {
  return (
    <div className="w-[80%] mx-auto ">
      <h3 className="text-lg text-center font-medium text-[#00CE3A] mb-2">
      ...
      <div className="relative">
        <img
          ...
          alt="logo"
          className="absolute -top-8 left-16 z-[-1]"
        />

        <h1 className="text-[40px] w-fit mx-auto text-center font-semibold text-[#2B2B2B] leading-[45px] mb-5">
          A foreigner with educational background, <br /> residence, employment,
          basic qualifications
        </h1>
      </div>

      <div
        className="px-20 py-20 mt-16 rounded-[32px]"
        style={{
